...
import static com.example.ghp.myapp_eventin.Constants.MAX_EXPECTED_TX_POWER;
import static com.example.ghp.myapp_eventin.Constants.MIN_EXPECTED_TX_POWER;
...
class UrlValidator {
  ...
  static void validate(String deviceAddress, byte[] serviceData, Beacon beacon) {
    ...
    Log.d("abcd",beacon.urlStatus.urlValue);
  }
