...
public class SelectUserAdapter extends BaseAdapter {
    ...
    public ArrayList<String> selectedNumbers= new ArrayList<String>();
        ...
        v.check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkBox.isChecked()) {
                    ...
                    Log.d ("Selected Number is",data.getName()+data.getPhone());
                    selectedNumbers.add(data.getPhone());
                    selectedUsers.add(data.getName());
...
//                            new SendMessage().execute();
                    ...
                    if(selectedNumbers.contains(data.getPhone())){
                        selectedNumbers.remove(data.getPhone());
                    }
                    if(selectedUsers.contains(data.getName())){
                        selectedUsers.remove(data.getName());
                    }
                }
            }
        });
